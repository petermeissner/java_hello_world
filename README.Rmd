...
- source: https://cran.r-project.org/web/packages/helloJavaWorld/index.html
- source: https://cran.r-project.org/web/packages/helloJavaWorld/vignettes/helloJavaWorld.pdf
- fix path and JAVA_HOME until package builds
